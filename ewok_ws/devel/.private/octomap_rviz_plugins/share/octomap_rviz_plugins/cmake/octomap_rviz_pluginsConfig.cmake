...
if("TRUE" STREQUAL "TRUE")
  set(octomap_rviz_plugins_SOURCE_PREFIX /home/drone/Documents/ewok_ws/src/Ewok-Planner/ewok/octomap_rviz_plugins)
  set(octomap_rviz_plugins_DEVEL_PREFIX /home/drone/Documents/ewok_ws/devel/.private/octomap_rviz_plugins)
  ...
  set(octomap_rviz_plugins_INSTALL_PREFIX /home/drone/Documents/ewok_ws/install)
...
if(NOT "/home/drone/Documents/ewok_ws/src/Ewok-Planner/ewok/octomap_rviz_plugins/include " STREQUAL " ")
  set(octomap_rviz_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/drone/Documents/ewok_ws/src/Ewok-Planner/ewok/octomap_rviz_plugins/include")
  ...
  elseif(NOT "http://ros.org/wiki/octomap_rviz_plugins " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Armin Hornung <armin@hornung.io>, Wolfgang Merkt <w.merkt+oss@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'octomap_rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/drone/Documents/ewok_ws/src/Ewok-Planner/ewok/octomap_rviz_plugins/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/drone/Documents/ewok_ws/devel/.private/octomap_rviz_plugins/lib;/home/drone/Documents/ewok_ws/devel/lib;/opt/ros/melodic/lib)
